                                      ...
                                      <a href="shop.html" class="has-mega-menu">
                                         ...
                                         <ul class="mega-menu tp-submenu">
                                            <li>
                                               ...
                                               <ul>
                                                  <li>
                                                   <a href="shop.html"><img src="/img/header/menu/menu-2.jpg" alt=""></a>
                                                  </li>
                                                  <li>
                                            ...
                                            <li>
                                               ...
                                               <ul>
                                                  <li>
                                                   <a href="shop.html"><img src="/img/header/menu/menu-3.jpg" alt=""></a>
                                                  </li>
                                                  <li>
                        ...
                        <div class="col-xl-3 col-lg-3">
                           <div class="tp-header-contact d-flex align-items-center justify-content-end">
                              ...
                              <div class="tp-header-contact-content">
                                 ...
                                 <p><a href="tel:402-763-282-46">+221 763 282 46</a></p>
                              </div>
                           </div>
                        </div>
                     </div>
